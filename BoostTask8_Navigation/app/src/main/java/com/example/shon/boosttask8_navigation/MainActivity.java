...
public class MainActivity extends AppCompatActivity
    ...
    final Uri CONTACT_URI = Uri
            .parse("content://com.example.shon.boosttask8_navigation/users");
    static final String USER_UID = "id";
...
//            updateUI(true);
    ...
    private void saveUserToFirebase(AuthData authData) {
        ...
        cv.put(USER_UID,(String) providerData.get("id"));
        cv.put(CONTACT_NAME,(String) providerData.get("displayName"));
        cv.put(CONTACT_EMAIL,(String) providerData.get("email"));
...
//            show massage
//            showMessage("Error", "Nothing in your Data");
//            return;
//        }
//
...
//            buffer.append("DisplayName : " + result.getString(1) + "\n");
//            buffer.append("Email : " + result.getString(2) + "\n");
//            buffer.append("ProfileImageUrl : " + result.getString(3) + "\n\n");
//        }
