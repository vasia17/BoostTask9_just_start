...
public class MyContactsProvider extends ContentProvider {
    ...
    // // Uri
    // authority
    static final String AUTHORITY = "com.example.shon.boosttask8_navigation";

    // path
    static final String CONTACT_PATH = "users";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case URI_CONTACTS_ID: // Uri с ID
                ...
                if (TextUtils.isEmpty(selection)) {
                    selection = USER_UID + " = " + id;
                } else {
                    selection = selection + " AND " + USER_UID + " = " + id;
                }
                break;
            default:
        ...
        Cursor cursor = db.query(USER_TABLE, projection, selection,
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        db = dbHelper.getWritableDatabase();
        int cnt = db.delete(USER_TABLE, selection, selectionArgs);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        db = dbHelper.getWritableDatabase();
        int cnt = db.update(USER_TABLE, values, selection, selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return cnt;
    }
